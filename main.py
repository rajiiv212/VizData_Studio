...
# from contact_form import contact
 ...
 # Page setup
st.set_page_config(page_title="VizData Studio",page_icon="📊", layout="wide")

# st.title("VizData Studio")
# st.markdown("### Your One-Stop Solution for Data Handling and Analysis")
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #C0C0C0;">
    <div class="navbar-brand" target="_blank">
        <span style="color: #333333; font-size: 44px;"> VizData Studio </span>
    </div>
...
# def main():
#     print("Hello from vizdata-studio!")
