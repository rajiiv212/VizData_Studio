...
from page6_auto_ml.classification_pycaret import classificationPycaret
from page6_auto_ml.regression_pycaret import regressionPycaret
from page6_auto_ml.clustering_pycaret import clusteringPycaret
from page6_auto_ml.forcasting_pycaret import timeseriesPycaret
from page6_auto_ml.anomaly_pycaret import anomalyPycaret
