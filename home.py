...
# st.set_page_config(page_title="VizData Studio", layout="wide")
def home_page():

        st.subheader("Welcome to VizData Studio")
        ...
        start_col1.markdown('<p style="color:#4FFF33; font-size: 22px; text-align: right;">To begin, click the button</p>',unsafe_allow_html=True)
